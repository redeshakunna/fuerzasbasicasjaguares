...
/** Cierre de página — invitación a sumarse, antes del Footer. */
      ...
      >
        ...
        <div className="relative flex items-start gap-5">
          <span className="hidden h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-jaguar-white/15 text-jaguar-white sm:flex">
            <Trophy className="h-6 w-6" strokeWidth={1.7} aria-hidden />
          </span>
          <div>
            ...
            <p className="mt-4 max-w-md text-[14.5px] leading-relaxed text-jaguar-white/75">
              Únete a nuestra familia y sé parte del legado Jaguares. El futuro empieza hoy.
            </p>
          </div>
        </div>
