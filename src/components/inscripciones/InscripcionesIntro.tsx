...
/** Apertura — invita a inscribirse, deja claro qué categoría está abierta. */
export function InscripcionesIntro() {
  return (
    <section className="bg-jaguar-white px-4 py-16 md:px-8 md:py-24 lg:px-12">
      <div className="mx-auto grid max-w-[1600px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        >
          <span className="inline-flex items-center gap-2 text-[13px] font-semibold uppercase tracking-[0.28em] text-jaguar-green-600">
            <span className="h-1.5 w-1.5 rounded-full bg-jaguar-green-500" />
            Inscripciones abiertas — Sub-15
          </span>
          <h2 className="mt-4 font-display text-4xl uppercase leading-[0.95] tracking-tight text-jaguar-ink md:text-5xl">
            Sé parte
            <br />
            <span className="text-jaguar-green-600">de Jaguares</span>
          </h2>
          <p className="mt-6 max-w-md text-base leading-relaxed text-jaguar-ink/65">
            Hoy abrimos inscripciones para nuestra categoría activa, Sub-15. Contáctanos y te acompañamos en cada
            paso del proceso, desde la primera prueba hasta el primer entrenamiento.
          </p>

          <Link
            href="mailto:info@jaguarescordoba.com"
        ...
        >
          <Image
            ...
            alt="Jugadores de Fuerzas Básicas Jaguares de Córdoba"
            fill
