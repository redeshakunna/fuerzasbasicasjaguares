...
/** Apertura — presenta al plantel sin exponer identidades de menores. */
export function JugadoresIntro() {
  return (
      ...
      <div className="mx-auto grid max-w-[1600px] grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        >
          ...
          <p className="mt-6 max-w-md text-base leading-relaxed text-jaguar-ink/65">
            28 jugadores conforman hoy la Sub-15, nuestra categoría activa. Por ser menores de edad, cuidamos su
            privacidad en este sitio público — pero cada uno tiene una hoja de vida deportiva completa dentro de
            nuestra plataforma interna, con seguimiento técnico, físico y actitudinal.
          </p>
        ...
        >
          <Image
            ...
            alt="Jugadores de la Sub-15 de Fuerzas Básicas Jaguares de Córdoba entrenando"
            fill
