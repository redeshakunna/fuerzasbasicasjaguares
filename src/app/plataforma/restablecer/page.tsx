...
export const metadata: Metadata = {
  title: "Restablecer contraseña — Plataforma Jaguares",
};
      ...
      <div className="w-full max-w-[400px]">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="mt-4 text-[20px] lg:text-[22px] font-extrabold text-jaguar-ink">
            Restablecer <span className="text-jaguar-green-600">contraseña</span>
          </h1>
          <p className="mt-1 text-[13px] lg:text-[14px] text-jaguar-ink/55">Elige tu nueva contraseña de acceso.</p>
        </div>
