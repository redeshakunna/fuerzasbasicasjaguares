...
export default async function ConfiguracionPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfiguracionTabs academia={academia} temporadas={temporadas} staff={staff} cargos={cargos} isAdmin={currentStaff?.isAdmin ?? false} />
    </div>
  );
}
